...
<style>
	...
	.WuiBrandLogo[data-provider^='apple'] {
	...
	.WuiBrandLogo[data-provider^='facebook'] {
	...
	.WuiBrandLogo[data-provider^='github'] {
	...
	.WuiBrandLogo[data-provider^='google'] {
	...
	.WuiBrandLogo[data-provider^='microsoft'] {
