...
<svelte:element this={elements[variant || 'body'][size || 'md']} class="WuiText WuiText--{variant} WuiText--{size} WuiText--{color} {bold ? 'WuiText--bold' : ''} {italic ? 'WuiText--italic' : ''} {rtl ? 'WuiText--rtl' : ''} {underline ? 'WuiText--underline' : ''} {_class}" style="{$$restProps.style || ''}" {...$$restProps}>
  <slot />
</svelte:element>
...
<style>
  ...
  .WuiText--body.WuiText--sm, .WuiText--label.WuiText--sm {
    --WuiText-font-size: 0.75rem;
    --WuiText-line-height: 0.875rem;
  }
  .WuiText--body.WuiText--md, .WuiText--label.WuiText--md {
    --WuiText-font-size: 0.8125rem;
    --WuiText-line-height: 1rem;
  }
  .WuiText--body.WuiText--lg, .WuiText--label.WuiText--lg {
